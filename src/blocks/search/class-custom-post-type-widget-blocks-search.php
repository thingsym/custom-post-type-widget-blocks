...
class Custom_Post_Type_Widget_Blocks_Search {
	...
	/**
	 * Renders the search block on server.
	 *
	 * @since 1.0.0
	 *
	...
	public function render_callback( $attributes ) {
		...
		$color_classes       = $this->get_color_classes_for_block_core_search( $attributes );
		...
		if ( $post_type ) {
			$query_params_markup .= '<input type="hidden" name="post_type" value="' . $post_type . '">';
		}
	 ...
	 */
	public function classnames_for_block_core_search( $attributes ) {
		$classnames   = [];
	 ...
	 */
	public function apply_block_core_search_border_style( $attributes, $property, $side, &$wrapper_styles, &$button_styles, &$input_styles ) {
	 ...
	 * @param array  $input_styles   Current collection of input styles.
	 */
	public function apply_block_core_search_border_styles( $attributes, $property, &$wrapper_styles, &$button_styles, &$input_styles ) {
		$this->apply_block_core_search_border_style( $attributes, $property, null, $wrapper_styles, $button_styles, $input_styles );
		$this->apply_block_core_search_border_style( $attributes, $property, 'top', $wrapper_styles, $button_styles, $input_styles );
		$this->apply_block_core_search_border_style( $attributes, $property, 'right', $wrapper_styles, $button_styles, $input_styles );
		$this->apply_block_core_search_border_style( $attributes, $property, 'bottom', $wrapper_styles, $button_styles, $input_styles );
		$this->apply_block_core_search_border_style( $attributes, $property, 'left', $wrapper_styles, $button_styles, $input_styles );
	}
	 ...
	 */
	public function styles_for_block_core_search( $attributes ) {
		$wrapper_styles   = [];
		$button_styles    = [];
		$input_styles     = [];
		$is_button_inside = ! empty( $attributes['buttonPosition'] ) &&
		...
		$this->apply_block_core_search_border_styles( $attributes, 'width', $wrapper_styles, $button_styles, $input_styles );
		$this->apply_block_core_search_border_styles( $attributes, 'color', $wrapper_styles, $button_styles, $input_styles );
		$this->apply_block_core_search_border_styles( $attributes, 'style', $wrapper_styles, $button_styles, $input_styles );
		...
		$typography_styles = esc_attr( $this->get_typography_styles_for_block_core_search( $attributes ) );
	 ...
	 */
	public function get_typography_classes_for_block_core_search( $attributes ) {
		$typography_classes    = [];
	 ...
	 */
	public function get_typography_styles_for_block_core_search( $attributes ) {
		$typography_styles = [];
	 ...
	 */
	public function get_border_color_classes_for_block_core_search( $attributes ) {
	 ...
	 */
	public function get_color_classes_for_block_core_search( $attributes ) {
		$classnames = [];
