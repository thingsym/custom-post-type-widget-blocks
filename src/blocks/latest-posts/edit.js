		...
		if ( ! hasPosts ) {
			return (
				<>
					...
					<Placeholder
						icon="admin-post"
						label={ __( 'Latest Posts', 'custom-post-type-widget-blocks' ) }
					>
			...
			<>
				...
				>
					{ displayPosts.map( ( post, i ) => {
						...
						let excerpt = post.hasOwnProperty('excerpt') ? post.excerpt.rendered : '';
...
export default withSelect( ( select, props ) => {
	...
	return {
		postTypes: postTypes,
		defaultImageWidth: imageDimensions ? imageDimensions[ featuredImageSizeSlug ].width : undefined,
		defaultImageHeight: imageDimensions ? imageDimensions[ featuredImageSizeSlug ].height : undefined,
		imageSizeOptions,
